...
namespace Lockstep
{
	public class LSEffect : MonoBehaviour
	{
        ...
        public ParticleSystem.MainModule CachedShurikenMain { get { return CachedShuriken.main; } }
        private float StartSpeed {
            get; set;
        }
        public float Speed {
            set {
                var CSmain = CachedShurikenMain;
                CSmain.startSpeed = value;
            }
        }
        ...
        internal void Setup (string myEffectCode)
		{
			...
			if(CachedShuriken){
                var CSmain = CachedShurikenMain;
                StartSpeed = CSmain.startSpeed.constant;
                StartSize = CSmain.startSize.constant;
			}
		...
		internal void Initialize ()
		{
            ...
            if (CachedShuriken != null) {
                var CSmain = CachedShurikenMain;
                CSmain.startSpeed = StartSpeed;
                CSmain.startSize = StartSize;
                CachedShuriken.Play();
            }
